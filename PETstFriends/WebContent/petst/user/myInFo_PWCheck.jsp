    ...
    <form action="getUserId.do " method="post">
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="user_pass"  name = "user_pass">
        				...
        				<input type ="submit"  name = "확인" value= "확인" style="width: 50px; height: 28px; background-color: #FFD232; border: 1 solid white">
							
<input type="button" value="취소"onclick="location.href='main.do'" style="width: 50px; height: 28px; background-color: #FFD232; border: 1 solid white">
        </form>
