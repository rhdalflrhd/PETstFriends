...
<body>
<c:choose>
<c:when test="${type eq 'naver'}">
	<c:set var="path" value="join_naverForm.do"/>
</c:when>
<c:otherwise>
	<c:set var="path" value="joinUserForm.do"/>
</c:otherwise>
</c:choose>


<form action= "${path }" name="form" method="post">
 <table width="1400" height="650">
  <tr>
   <td width="100%" height="100%"><span style="padding-left: 160px"><img
    src="img/PF.png" width="100" height="100" border="0"
