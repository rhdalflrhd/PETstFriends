...
<center>
		...
		<table>
			...
			<c:forEach items="${rabbitFreeBoardList }" var="Freeboard">
				<tr>
			...
			<tr>
				<td width="1250px" colspan="3"><c:if test="${start != 1 }">
						<a
							href="rabbitFreeBoardList.do?page=1&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[처음]</a>
						<a
							href="rabbitFreeBoardList.do?page=${start-1 }&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[이전]</a>
						...
						<c:choose>
							...
							<c:otherwise>
								<a
									href="rabbitFreeBoardList.do?page=${i }&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[${i }]</a>
							</c:otherwise>
						</c:choose>
					</c:forEach> <c:if test="${end < last}">
						<a
							href="rabbitFreeBoardList.do?page=${end+1 }&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[다음]</a>
						<a
							href="rabbitFreeBoardList.do?page=${last }&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">[끝]</a>
					</c:if></td>
