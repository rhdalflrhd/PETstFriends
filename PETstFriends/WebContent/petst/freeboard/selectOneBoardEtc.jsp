...
<script type="text/javascript">
	$(document).ready(function() {
		$('#deleteBtn').click(function() {
			...
			if (result == true) {
				alert("성공적으로 삭제되었습니다.")
				location.href = 'etcDeleteFreeBoard.do?freeBoard_boardno=' + $
				{
					freeBoard_boardno
				}
				;
	...
	<div class="wrapper">
		...
		<c:if test="${freeBoard.freeBoard_userId eq user_idCheck}">
						<input type="button" style="color: black;" value="수정하기"
							onclick="location.href='etcModifyFreeBoardForm.do?freeBoard_boardno=${freeBoard.freeBoard_boardno}&freeBoard_boardname=${freeBoard.freeBoard_boardname }'">

					</c:if> <input type="button"  style="color: black;" value="목록"
					onclick="location.href='etcFreeBoardList.do'"> 
					<input type="button"  style="color: black;"
					value="뒤로" onclick="history.back();" />
					 <c:if
 						test="${freeBoard.freeBoard_userId eq user_idCheck}">
						<form
 							action="etcDeleteFreeBoard.do?freeBoard_boardname=${freeBoard.freeBoard_boardname}&freeBoard_boardno=${freeBoard.freeBoard_boardno}'" 
