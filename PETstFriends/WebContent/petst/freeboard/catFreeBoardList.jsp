...
<!-- 						마우스올리면 오버레이~~ -->
						<div class="img-overlay">
							<div class="portfolio-text">
								...
								<a 
									href="selectOneBoardCat.do?freeBoard_boardno=${freeBoard.freeBoard_boardno }&freeBoard_boardname=${freeBoard.freeBoard_boardname }&page=${current}&type=${type }&keyword=${keyword }&startDate=${startDate}&endDate=${endDate}">click</a>
							</div>
						</div>
					</div>
					</c:forEach>
