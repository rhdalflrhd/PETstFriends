...
<body>
	<button class="openMask"
		style="height: 62px; background-color: #CD853F; border: none; padding: 5px 10px; border-radius: 5px; color: white; font-size: 35px">쪽지
		보내기</button>
	<div id="mask"></div>
	
	
	
	<button id="msgdeleteAdminbutton"
		style="height: 62px; background-color: #CD853F; border: none; padding: 5px 10px; border-radius: 5px; color: white; font-size: 35px"
		value="1">관리자 쪽지 삭제</button>
	...
	<center>
		...
		<button id="search"
			style="height: 40px; background-color: #CD853F; border: none; padding: 5px 10px; border-radius: 5px; color: white; font-size: 20px">검색</button>
	</center>
