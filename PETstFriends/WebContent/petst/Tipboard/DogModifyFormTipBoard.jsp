					...
					<article class="post" style="border: 1px solid #eeeeee;">
						...
						<center>
							<div class="leave-comment"
								...
								<br>
								<br>
								<form action="DogModifyTipBoard.do"	method="post" enctype="multipart/form-data" class="form-horizontal contact-form" id="modifyTipBoardFrm">
                            ...
                            <ul class="text-center">
                                ...
                                <li><a class="s-twitter" ><input type="button" value="목록으로"  class="write-btn" onclick="location.href='dogTipBoardList.do'"></a></li>
