		...
		<div class="container">
			...
			<div class="heading-text text-center text-uppercase">
				<font
					...
					강아지 꿀 TIP 게시판 </font>&nbsp;<input type="button" value="글쓰기"
					onclick="location.href='DogWriteTipBoardForm.do'"
...
<!-- =====================================================================사용자 입력 Tip게시글 div 시작!!===================================================-->			
			<div style="background: rgba( 244, 159, 0, 0.7 );border: 1px solid #eeeeee; ">
			<article> 
...
<br>
					<font
						...
						총 게시물 : ${dogTipBoardCount }개&nbsp;&nbsp;&nbsp; </font> <label
			...
			<div class="portfolio">
				<c:forEach items="${dogTipBoardList }" var="tipboard" varStatus="i">
					<div id="${tipboard.tipBoard_boardno}" class="portfolio-item"
						style="width: 345px; height: 500px; border: 1px #F2F2F2 solid;">
						...
						<div
							style="display: inline-block; width: 340px; height: 200px; padding-left: none; text-align: left; border: 1px #F2F2F2 solid;">
							<h5>
						...
						<div class="img-overlay">
							<div class="portfolio-text">
								...
								<a
									href="DogReadTipBoard.do?boardname=${tipboard.tipBoard_boardname}&boardno=${tipboard.tipBoard_boardno}">click</a>
			...
			<div class="numbers">
				...
				<div class="col-md-3" align="right">
					<input type="button"
						...
						value="글쓰기" onclick="location.href='DogWriteTipBoardForm.do'">
				</div>
			</div><br><br>
			</article>
</div><br><br><br><br>
...
<!-- ======================================================네이버 API결과 시작===============================================================-->
			<div style="background: rgba(109, 45, 0, 0.7); border: 1px solid #eeeeee;">
				<br>
				<h2 align="left"
				...
				<div class="portfolio">
					...
					<c:forEach items="${DogEncycList1 }" var="e" varStatus="i">
						<div id="${e.encyc_title}" class="portfolio-item"
							style="width: 345px; height: 450px; border: 1px #F2F2F2 solid;">
							<div style="height: 285px;">
							...
							<div
								style="display: inline-block; width: 340px; height: 150px; padding-left: none; text-align: left; border: 1px #F2F2F2 solid;">
								<h5>
									<font
										style="font-family: 'NanumSquareRound', sans-serif; font-weight: bold; color: #8B5927;">
				...
				<!-- 				<a href="#"> <i class="fa fa-refresh"></i> load more -->
				<!-- 				</a> -->
				<!-- 			</div> -->
			</div>
