...
<body>
	<center>
		...
		<div style="border: 1px solid red; height: 1000px; width: 45%; background-color: white;">
			<form action="modifyOftenQnA.do" method="post" id="modifyBoardFrm"
				enctype="multipart/form-data">
				<span id="title">
				제목 :</span> <input type="text" id="oftenQnA_title" name="oftenQnA_title" value="${oftenQnA.oftenQnA_title }"
