...
<img alt="프로필 사진" src="/images/user-empty.png" id="avatar_image"  width="400x" height="400px"></td></tr>
</table>
</td><td>

<table style="width: 600; height: 400; font-size: 16px">
...
background-color:white; color:#CD853F; border:1; border-coloㄴr:#CD853F; border-radius:5px;"></td></tr>
...
<form name="form" id="form" method="post">
	<table style="width: 600px; font-size: 16px">
			<tbody>
				<tr>
					<td style="padding-left:10px; width: 50%; border:2; border-color:#CD853F; border-radius:5px; width: 90px; padding: 5px; background-color:white; color:#CD853F; border:1; border-color:#CD853F; border-radius:5px;" >도로명주소</td>
					<td><input type="hidden" id="confmKey" name="confmKey" value=""  >
					<input readonly="readonly" type="text" id="roadAddrPart1" style="width:370px; background-color:white; color:#CD853F; font-family: 'NanumSquareRound',sans-serif; padding: 4px; border:1; 
	border-color:#CD853F; border-radius: 5px;"></td>
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" id="addrDetail" style="width:457px; background-color:white; color:#CD853F; font-family: 'NanumSquareRound',sans-serif; padding: 4px; border:1; 
...
<table style="margin: auto; width: 1000px; border-color:#CD853F;"><tr><td>
	...
	<p align="center">
		<input type="button" onclick="location.href='meeting.do'" style="font-size: 14pt" value="취소" class="write-btn"/>
		<input type="button" onclick="submitContents(this);" style="font-size: 14pt" value="개설 완료" class="write-btn"/>
</p>
</td></tr></table>	
</td></tr>
</table>
